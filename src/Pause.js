...
const Pause = ({ pauseFunctions, currentConfThresh }) => {
    return (
        <div className="pause_menu_container">
            <div className="conf_thresh_text">
                <StringEffect text="Confidence Threshold" />
            </div>
            <div className="pause_options confidence_threshold_container">
                <Button
                    ...
                    classes_text={`${
                        currentConfThresh === 0.6 ? "conf_option_selected" : ""
                    }`}
                ...
                <Button
                    ...
                    classes_img={`conf_option`}
                    classes_text={`${
                        currentConfThresh === 0.7 ? "conf_option_selected" : ""
                    }`}
                ...
                <Button
                    ...
                    classes_img={`conf_option`}
                    classes_text={`${
                        currentConfThresh === 0.8 ? "conf_option_selected" : ""
                    }`}
